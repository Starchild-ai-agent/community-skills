---
name: "@5386/fvg-delta-crypto-engine-skill"
version: 6.0.0
---
...
`app.py` (engine), `trades.html` (Trade History page), `market.js` (market rail +
notifications + Telegram test), `Dockerfile`, `start.sh`, `run_one_shot.sh`,
`preflight_check.py`, `requirements.txt`, `AGENT.md` (maintainer guide + v6.0 changelog),
